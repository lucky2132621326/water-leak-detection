...
result) to a local JSONL file, independent of MongoDB while Live Sensor Mode is
active.

This provides a recoverable raw record alongside MongoDB without allowing a
file-write failure to stop detection.
